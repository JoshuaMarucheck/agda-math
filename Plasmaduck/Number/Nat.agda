...
open import Data.Nat using (ℕ; _+_; _*_; _≤_; _≥_; _<_; _∸_; <-cmp; _<?_; s≤s; z≤n; s≤s⁻¹; zero; suc)
open import Data.Nat.Properties using (<-irrefl; <-≤-trans; ≤-trans; ≤-reflexive; +-comm; +-suc)
